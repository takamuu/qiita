...
Contract.create!(user_id: user3.id, product_id: product1.id, product_name: product1.product_name, contract_money: 500000, contract_status: 0)

puts "契約データの投入に成功しました！"
